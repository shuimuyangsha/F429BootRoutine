...
static const GUI_WIDGET_CREATE_INFO _aDialogCreateNetwork[] = {
  { FRAMEWIN_CreateIndirect,  "Network",                     0,  0,   0,   800, 480, 0, 0x0,  0 },
  { DROPDOWN_CreateIndirect,  "NetTpye",      GUI_ID_DROPDOWN0,  10,  30,  130, 27,  0, 0x0,  0 },
  { BUTTON_CreateIndirect,    "Connect",      GUI_ID_BUTTON0,    170, 27,  90,  32,  0, 0x0,  0 },  
  { EDIT_CreateIndirect,      "REMOTEIPAdd1", GUI_ID_EDIT0,      10,  135, 45,  25,  0, 0x3,  0 },
  { EDIT_CreateIndirect,      "REMOTEIPAdd2", GUI_ID_EDIT1,      70,  135, 45,  25,  0, 0x3,  0 },
  { EDIT_CreateIndirect,      "REMOTEIPAdd3", GUI_ID_EDIT2,      130, 135, 45,  25,  0, 0x3,  0 },
  { EDIT_CreateIndirect,      "REMOTEIPAdd4", GUI_ID_EDIT3,      190, 135, 45,  25,  0, 0x3,  0 },
  { EDIT_CreateIndirect,      "REMOTEPort",   GUI_ID_EDIT4,      260, 135, 70,  25,  0, 0x4,  0 },
  { MULTIEDIT_CreateIndirect, "SendBuf",      GUI_ID_MULTIEDIT0, 390, 30,  385, 160, 0, 0x0,  0 },
  { MULTIEDIT_CreateIndirect, "ReceiveBuf",   GUI_ID_MULTIEDIT1, 10,  200, 765, 230, 0, 0x0,  0 },
  { BUTTON_CreateIndirect,    "Clear",        GUI_ID_BUTTON2,    200, 170, 90,  27,  0, 0x0,  0 },
  { BUTTON_CreateIndirect,    "Send",         GUI_ID_BUTTON1,    275, 27,  90,  32,  0, 0x0,  0 },
...
static void _cbDialogNetwork(WM_MESSAGE * pMsg) {
 ...
 case WM_PAINT:
   ...
   GUI_DispStringAt(tempstr,390,10); 
   sprintf(tempstr,"%s%s:",UTF8_DATA,UTF8_RECEIVE);
   GUI_DispStringAt(tempstr,10,180); 
   GUI_DispStringAt(UTF8_PORT,260,115); 
 
   switch(drv_network.net_type)
   {
     case 0:
       sprintf(tempstr,"%sIP%s:",UTF8_SERVER,UTF8_ADDRESS);
       GUI_DispStringAt(tempstr,10,115); 
       break;
     case 1:
     case 2:
   ...
   GUI_DispStringAt(tempstr,10,65);    
   
   GUI_SetFont(GUI_FONT_24B_ASCII); 
   GUI_SetColor(GUI_WHITE);
   GUI_DispCharAt('.',60,135);
   GUI_DispCharAt('.',120,135);
   GUI_DispCharAt('.',180,135);
   GUI_DispStringAt(":",243,135); 
   ...
   GUI_DispStringAt(tempstr,20,85); 
...
void FUN_ICON6Clicked(void) 
{
  ...
  WM_HWIN hWin;
  TEXT_Handle htext;
  OS_INFO("NetworkDLG create\n");

  hWin = GUI_CreateDialogBox(_aDialogCreateNetwork, GUI_COUNTOF(_aDialogCreateNetwork), _cbDialogNetwork, HDTWIN, 0, 0);
  drv_network.hWin=hWin;
  htext=TEXT_CreateEx(250,200,300,50,hWin,WM_CF_SHOW|WM_CF_STAYONTOP,TEXT_CF_HCENTER|GUI_TA_VCENTER,GUI_ID_TEXT9,"Initialize Network...");
