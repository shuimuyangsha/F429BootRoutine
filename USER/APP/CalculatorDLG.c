...
void FUN_ICON12Clicked(void)  
{
  ...
  calculator.Operator1=0;
  calculator.Operator2=0;
  hWin = GUI_CreateDialogBox(_aDialogCreateCalculator, GUI_COUNTOF(_aDialogCreateCalculator), _cbDialogCalculator, HDTWIN, 0, 0);
  while(Flag_ICON12)
  {
